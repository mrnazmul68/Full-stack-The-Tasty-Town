...
const cakeItems = food_list.filter((item) => item.category === 'Cake');

const Menu5 = ({ cartItems, onAddToCart, onRemoveFromCart, onOrderItem, onBack }) => {
  return (
    <section className="py-12 sm:py-16">
      ...
      <div className="mb-10 space-y-3">
        ...
        <h2 className="text-3xl font-bold sm:text-4xl">Soft slices and celebration cakes</h2>
        <p className="max-w-2xl text-sm leading-7 text-slate-300 sm:text-base">
          Pick from rich, creamy, and fluffy cake favorites that turn any moment into
          a sweet treat.
        </p>
      </div>
