...
const noodleItems = food_list.filter((item) => item.category === 'Noodles');

const Menu8 = ({ cartItems, onAddToCart, onRemoveFromCart, onOrderItem, onBack }) => {
  return (
    <section className="py-12 sm:py-16">
      ...
      <div className="mb-10 space-y-3">
        ...
        <h2 className="text-3xl font-bold sm:text-4xl">Hot noodle bowls and stir-fry favorites</h2>
        <p className="max-w-2xl text-sm leading-7 text-slate-300 sm:text-base">
          Pick buttery, veggie, and classic noodle dishes full of flavor and comfort.
        </p>
      </div>
