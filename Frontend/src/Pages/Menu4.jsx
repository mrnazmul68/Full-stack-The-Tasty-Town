...
const sandwichItems = food_list.filter((item) => item.category === 'Sandwich');

const Menu4 = ({ cartItems, onAddToCart, onRemoveFromCart, onOrderItem, onBack }) => {
  return (
    <section className="py-12 sm:py-16">
      ...
      <div className="mb-10 space-y-3">
        ...
        <h2 className="text-3xl font-bold sm:text-4xl">Fresh sandwiches for every craving</h2>
        <p className="max-w-2xl text-sm leading-7 text-slate-300 sm:text-base">
          Choose from crispy, grilled, and classic sandwiches made for quick bites
