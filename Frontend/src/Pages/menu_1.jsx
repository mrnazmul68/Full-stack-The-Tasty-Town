...
const burgerItems = food_list.filter((item) => item.category === 'Burger');

const Menu1 = ({ cartItems, onAddToCart, onRemoveFromCart, onOrderItem, onBack }) => {
  return (
    <section className="py-12 sm:py-16">
      ...
      <div className="mb-10 space-y-3">
        ...
        <h2 className="text-3xl font-bold sm:text-4xl">Different types of burgers</h2>
        <p className="max-w-2xl text-sm leading-7 text-slate-300 sm:text-base">
          Explore our burger collection and pick from cheesy, crispy, spicy, and
          double-patty favorites.
        </p>
      </div>
