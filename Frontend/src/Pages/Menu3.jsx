...
const dessertItems = food_list.filter((item) => item.category === 'Deserts');

const Menu3 = ({ cartItems, onAddToCart, onRemoveFromCart, onOrderItem, onBack }) => {
  return (
    <section className="py-12 sm:py-16">
      ...
      <div className="mb-10 space-y-3">
        ...
        <h2 className="text-3xl font-bold sm:text-4xl">Sweet treats and cold desserts</h2>
        <p className="max-w-2xl text-sm leading-7 text-slate-300 sm:text-base">
          Enjoy our creamy ice creams and sweet dessert favorites whenever you want
          something cool, rich, and satisfying.
        </p>
      </div>
